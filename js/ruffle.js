(() => {
  ...
  (r.m = t),
    ...
    (r.u = (e) =>
      "core.ruffle." +
      { 69: "e33c253bda9c34f59f90", 655: "c1d60dee0c2dd3d779b3" }[e] +
      ".js"),
    (r.g = (function () {
  ...
  function E(e, n, t) {
    return n[t]
      ? F(e, n[t].value)
      : (e.reportError(new RangeError("No default")), new k());
  }
  function C(e, n) {
    const t = [],
  ...
  function A(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new y(n.value, { minimumFractionDigits: n.precision });
      case "var":
        return (function (e, { name: n }) {
          ...
          switch (typeof t) {
            ...
            case "number":
              return new y(t);
            case "object":
              if (t instanceof Date) return new R(t.getTime());
            default:
              return (
                e.reportError(
                  new TypeError(
      ...
      case "mesg":
        return (function (e, { name: n, attr: t }) {
          ...
          return e.reportError(new ReferenceError(`No value: ${n}`)), new k(n);
        })(e, n);
      case "term":
        return (function (e, { name: n, attr: t, args: a }) {
          ...
          if (!o)
            return (
              e.reportError(new ReferenceError(`Unknown term: ${r}`)), new k(r)
            );
          if (t) {
      ...
      case "func":
        return (function (e, { name: n, args: t }) {
          ...
          try {
            ...
            return e.reportError(t), new k(`${n}()`);
          }
        })(e, n);
      case "select":
        return (function (e, { selector: n, variants: t, star: a }) {
          let r = A(e, n);
          if (r instanceof k) return E(e, t, a);
          for (const n of t) {
  ...
  function q(e, n) {
    if (e.dirty.has(n))
      return e.reportError(new RangeError("Cyclic reference")), new k();
    e.dirty.add(n);
    const t = [],
      a = e.bundle._useIsolating && n.length > 1;
    for (const r of n)
      if ("string" != typeof r) {
        if ((e.placeables++, e.placeables > x))
          throw (
            (e.dirty.delete(n),
            new RangeError(
              `Too many placeables expanded: ${e.placeables}, max allowed is ${x}`
            ))
          );
        a && t.push(z), t.push(A(e, r).toString(e)), a && t.push(j);
  ...
  function $(e, n) {
    let t = e[0];
    if (t instanceof k) return new k(`NUMBER(${t.valueOf()})`);
    if (t instanceof y) return new y(t.valueOf(), { ...t.opts, ...P(n, O) });
    if (t instanceof R) return new y(t.valueOf(), { ...P(n, O) });
  ...
  function I(e, n) {
    let t = e[0];
    if (t instanceof k) return new k(`DATETIME(${t.valueOf()})`);
    if (t instanceof R) return new R(t.valueOf(), { ...t.opts, ...P(n, M) });
    if (t instanceof y) return new R(t.valueOf(), { ...P(n, M) });
  ...
  class W {
    constructor(
      ...
      (this._terms = new Map()),
        ...
        (this._functions = { NUMBER: $, DATETIME: I, ...n }),
    ...
    formatPattern(e, n = null, t = null) {
      ...
      try {
        ...
        if (a.errors && e instanceof Error)
          return a.errors.push(e), new k().toString(a);
        throw e;
      }
    }
  }
    ...
    constructor(e) {
      ...
      function l() {
        ...
        return r
          ? a
            ? u([a, r], r.length)
            : ((r.value = b(r.value, G)), u([r], r.length))
          : a
          ? b(a, Y)
          : null;
      }
      ...
      function c() {
        ...
        if (r(ie)) {
          ...
          return r(te, SyntaxError), { type: "select", selector: e, ...n };
        }
      ...
      function d() {
        ...
        if (t(J)) {
          ...
          if (r(oe)) {
            ...
            if (V.test(a)) return { type: "func", name: a, args: o };
  ...
  xe.content.appendChild(
    ...
    xe.content.appendChild(
      (0, b.jsx)(function () {
        return (0, b.jsx)("style", { id: "dynamic-styles" });
      }, {})
    ),
    xe.content.appendChild(
      (0, b.jsx)(function () {
  ...
  function Le(e, n, t, a) {
    ...
    let { body: o, actions: i } = (function (e) {
      if (e instanceof Pe)
        return e.swfUrl && !e.swfUrl.protocol.includes("http")
          ...
          ? { body: ye("error-swf-fetch"), actions: [We.ShowDetails] }
          : {
              body: ye("error-swf-cors"),
              actions: [
                We.openWiki("Using-Ruffle#configure-cors-header"),
                We.ShowDetails,
              ],
            };
      if (e instanceof Oe)
        return { body: ye("error-invalid-swf"), actions: [We.ShowDetails] };
      if (e instanceof $e) {
        ...
        if (n.includes("mime"))
          return {
            ...
            actions: [
              We.openWiki("Using-Ruffle#configure-webassembly-mime-type"),
              We.ShowDetails,
            ],
          };
        ...
        if (n.includes("disallowed by embedder"))
          return {
            ...
            actions: [
              We.openWiki("Using-Ruffle#configure-wasm-csp"),
              We.ShowDetails,
            ],
          };
        ...
        if (
          ...
          return { body: ye("error-wasm-download"), actions: [We.ShowDetails] };
        if ("TypeError" === e.cause.name) {
          const e = ye("error-javascript-conflict");
          return (
            Te() &&
              e.appendChild(
                ye("error-javascript-conflict-outdated", {
                  buildDate: Fe.buildDate,
                })
              ),
            { body: e, actions: [We.createReportOrUpdate(), We.ShowDetails] }
          );
        }
        return navigator.userAgent.includes("Edg") &&
          ...
          : {
              ...
              actions: [
                We.openWiki("Using-Ruffle#configuration-options"),
                We.ShowDetails,
              ],
            };
      }
      return e instanceof Me
        ? {
            ...
            actions: [
              We.openWiki("Using-Ruffle#javascript-api"),
              We.ShowDetails,
            ],
          }
        : {
    ...
    const s = (0, Ie.createRef)(),
      l = () => {
        s.current.classList.add("details"),
          s.current.replaceChildren(
            (0, b.jsx)("textarea", { readOnly: !0, children: r })
          );
      };
    (e.textContent = ""),
      e.appendChild(
        (0, b.jsxs)("div", {
          ...
          children: [
            ...
            (0, b.jsx)("div", { id: "panic-body", ref: s, children: o }),
            (0, b.jsx)("div", {
              id: "panic-footer",
              children: (0, b.jsx)("ul", {
                children: i.map((e) =>
  ...
  async function Ke(e) {
    null === Ze &&
      (Ze = (async function (e) {
        He();
        const n = (await Promise.all([_e(), Je(), Ne(), Be(), Ue()])).every(
          Boolean
        );
        n ||
          console.log(
      ...
      for (; a < 999; ) {
        ...
        if (
          ...
          return (
            ...
            (Qe[e] = { class: n, name: t, internalName: e }),
            t
          );
        a += 1;
      }
  ...
  function Xe(e, n) {
    if (
      (Ye(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      Ye(n.backgroundColor) &&
  ...
  class on {
    ...
    async ensureFreshInstance() {
      ...
      const [e, n] = await Ke(this.onRuffleDownloadProgress.bind(this)).catch(
        (e) => {
      ...
      if (
        ...
        !this.loadedConfig ||
          this.loadedConfig.autoplay === l.On ||
          (this.loadedConfig.autoplay !== l.Off &&
            "running" === this.audioState()))
      ) {
        if ((this.play(), "running" !== this.audioState())) {
          (this.loadedConfig && this.loadedConfig.unmuteOverlay === c.Hidden) ||
          ...
          try {
            (this.loadedConfig = {
              ...
              this.loadedConfig.backgroundColor &&
                this.loadedConfig.wmode !== f.Transparent &&
    ...
    confirmReloadSave(e, n, t) {
      if (this.isB64SOL(n) && localStorage[e]) {
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              ke("save-reload-prompt", { action: t ? "replace" : "delete" })
            ) &&
            this.loadedConfig &&
            (this.destroy(),
      ...
      if (
        ("contextmenu" === e.type
          ...
          : (document.documentElement.addEventListener(
            ...
            e.stopPropagation()),
        [!1, p.Off].includes(this.loadedConfig?.contextMenu ?? p.On) ||
          (this.isTouch &&
            this.loadedConfig?.contextMenu === p.RightClickOnly) ||
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = ke("clipboard-message-description", {
  ...
  class kn extends bn {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !fn(e) && (cn(n) ? (dn(e, "src"), !1) : Ce(n, t));
    }
