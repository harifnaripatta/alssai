...
(() => {
  ...
  var e,
    t,
    s = { createElementNS: document.createElementNS };
  var n = !0;
  function i(e) {
    n = e;
  }
  ...
  function C(e, t, s) {
    ...
    function c(e, s) {
      let n =
        arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "src";
                ...
                if (null == t) console.log("%s: no Memento-Datetime", h);
                  ...
                  var s = document.createElement("span"),
                    r = (function (e, t) {
                      ...
                      var i = !1;
                      if (s < 1e3) return { delta: s, text: "", highlight: i };
                      var o = s,
                      ...
                      return (
                        a > 1
                          ? (d.push(a + " years"), (i = !0))
                          : 1 == a && (d.push(a + " year"), (i = !0)),
                        r > 1
                          ? (d.push(r + " months"), (i = !0))
                          : 1 == r && (d.push(r + " month"), (i = !0)),
                        l > 1
                          ? d.push(l + " days")
                          : 1 == l && d.push(l + " day"),
                        c > 1
                        ...
                        { delta: o, text: n + d.join(" "), highlight: i }
                      );
                    })(t, o),
                  ...
                  p.sort(function (e, t) {
                    ...
                    (n.innerHTML = "");
                  for (var m = 0, f = p.length; m < f; m++) n.appendChild(p[m]);
                }
              }
  ...
  function H(e) {
    ...
    if (t.length > 0)
      for (var s = 0; s < t.length; s++) T(t[s]).classList.add("wb-highlight");
  }
  function _(e) {
    var t = M(window, e.target.href);
    if (t.length > 0)
  ...
  function x(e, t) {
    for (
      var s = e.document.getElementsByTagName(t),
  ...
  class N {
      ...
      if (
        ...
        if (
          ...
          i + this.sc.suggestionHeight - this.sc.maxHeight > 0
            ? (this.sc.scrollTop =
                i + this.sc.suggestionHeight + n - this.sc.maxHeight)
            : i < 0 && (this.sc.scrollTop = i + n);
        }
    }
    blurHandler() {
      try {
    ...
    keydownHandler(e) {
      ...
      if ((40 == s || 38 == s) && this.sc.innerHTML)
        return (
          (n = this.sc.querySelector(".wb-autocomplete-suggestion.selected"))
            ? (t = 40 == s ? n.nextSibling : n.previousSibling)
      ...
      if (27 == s)
        ...
        (n = this.sc.querySelector(".wb-autocomplete-suggestion.selected")) &&
          ...
          (this.onSelect(e, n.getAttribute("data-val"), n),
          setTimeout(() => {
            this.sc.style.display = "none";
          }, 20));
      }
    ...
    save(e) {
      ...
      this.start(),
        ...
        l(
          ...
          A.stringify({ url: t, snapshot: s, tags: n || [] })
        );
    }
    start() {
      this.hide([
  ...
  function X(e) {
    const t = W("wm-expand");
    t.classList.contains("wm-closed")
      ? (e && q.classList.add("notice-only"),
        t.classList.replace("wm-closed", "wm-open"),
        (q.style.display = "block"),
        C(F, P, W))
      : (t.classList.replace("wm-open", "wm-closed"),
  ...
  function G(e, t) {
    c(e) || (e = [e]);
    for (var s = 0; s < e.length; s++) J(e[s], t);
  }
  ...
  window.__wm = {
    ...
    wombat: function (e, s, i, o, a, r) {
      const l = `${i}${o}/`,
        ...
        h = i.replace(/^https?:/, ""),
        u = [
          "http://athena.archive.org/",
          "https://athena.archive.org/",
          "//athena.archive.org/",
      ...
      a.startsWith(i) ||
        a.startsWith(h) ||
        (u.push(a), /^\/\//.test(a) ? u.push(c.protocol + a) : /^\//.test(a));
      const d = new URL(e),
        p = {
          url: e,
          timestamp: s,
          ...
          wombat_host: d.host,
          wombat_opts: { no_rewrite_prefixes: u },
        };
    ...
    bt: function (e, t, s, n, i, a, r, c, h, u, d) {
      ...
      var H,
        ...
        S = W("wm-ipp-base");
      if (S.attachShadow) {
        var k = S.attachShadow({ mode: "closed" });
        for (B = k; S.children.length > 0; ) k.appendChild(S.children[0]);
        if (u)
      ...
      function J() {
        const e = W("donato")?.offsetHeight || 0,
          t = W("wm-ipp-inside").offsetHeight - W("wm-capinfo").offsetHeight,
          s = e + t;
        console.debug(
          "adjustHeight: donatoHeight=%s, toolbarHeight=%s -> baseHeight=%s",
          e,
          t,
          s
        ),
      ...
      W("wm-tb-close").addEventListener("click", (e) => {
        (W("wm-ipp-inside").style.display = "none"), e.preventDefault(), J();
      });
        ...
        if (t !== H) {
          ...
          t
            ...
            : ((s.className = ""),
              ...
              (i.innerHTML = g(M - 1)),
              (o.innerHTML = y(T, 2))),
            (_.style.display = t ? "inline" : "none"),
            (x.style.display = t ? "inline" : "none"),
            (H = t);
        }
      }
      W("wm-expand").addEventListener("click", Y),
        (q = W("wm-capinfo")),
        (W("wm-graph-anchor")._no_rewrite = !0),
        ((_ = j.createElement("div")).className = "yt"),
        (_.style.display = "none"),
        (_.style.width = s + "px"),
        (_.style.height = t + "px"),
        ((x = j.createElement("div")).className = "mt"),
          ...
          var i,
            ...
            h =
              ...
              (void 0 !== i.getBoundingClientRect
                ...
                (window.scrollX || o.scrollLeft) -
                (o.clientLeft || 0)),
            u = Math.min(Math.max(0, l - h), e),
            d = u % s,
            m = Math.floor(u / s),
            f = Math.min(11, Math.floor(d / n)),
            v = 12 * m + f,
            w = d % 2 == 1 ? 15 : 1,
            b = y(m + c) + y(f + 1, 2) + y(w, 2) + "000000";
          (W("displayYearEl").innerHTML = m + c),
            (W("displayMonthEl").innerHTML = g(f));
          var C = p + b + "/" + a;
          if (((W("wm-graph-anchor").href = C), L != m)) {
            var M = m * s;
            (_.style.left = M + "px"), (L = m);
          }
          if (E != v) {
            var T = m + v * n + 1;
            (x.style.left = T + "px"), (E = v);
          }
        });
          ...
          function (s) {
            if (200 == s.status) {
              ...
              !(function (e) {
                ...
                for (
                  var s = 0, n = e.years, i = e.first_ts, o = e.last_ts, r = 0;
                  r < n.length;
                  r++
                )
                ...
                (h.className = "t"),
                  ...
                  (h.innerText = `${
                    ((u = s), ("" + u).replace(/\B(?=(\d{3})+$)/g, ","))
                  } ${s > 1 ? "captures" : "capture"}`);
                var d = v(i, "%d %b %Y");
                o != i && (d += ` - ${v(o, "%d %b %Y")}`);
                ...
                (function (e, t, s, n, i, o, a) {
                  ...
                  if (r) {
                    ...
                    for (var f = (c - 1) / 12, g = 0; g < u.length; g++) {
                      m = u[g][0];
                      for (var v = u[g][1], y = H(m) + 1, C = 0; C < 12; C++) {
                        var M = v[C];
                        if (M > 0) {
                          var T = Math.ceil(M * d);
      ...
      (W("wm-share-facebook").onclick = function (e) {
        ...
        new R(W("wmtbURL"), {
          ...
          source: function (e, t) {
            l(
              ...
              function (s) {
                if (
                  void 0 !== (s = O.parse(s.response)).hosts &&
                  s.hosts.length > 0
                ) {
                  var n = ae(s.hosts);
                  t(n);
                } else
                  void 0 !== s.isUrl && !0 === s.isUrl && void 0 === s.excluded
                    ? t([e])
                    : l(
                        "GET",
        ...
        (W("wmtb").onsubmit = function (e) {
          ...
          if (
            ...
            return (
              (document.location.href = "/web/*/" + W("wmtbURL").value),
              e.preventDefault(),
              !1
            );
        }),
        (function (e, t, s) {
          !(function (e, t) {
            ...
            function (e, n) {
              ...
              if (!i)
                return (
                  console.warn("failed to extract timestamp from %s", n),
                  void s(!1)
                );
          ...
          e
            ? ((W("wm-screenshot").title = "screenshot (delta: " + t + "s)"),
              G("wm-screenshot", !0))
            : G("wm-screenshot", !1);
        }),
        d &&
      ...
      if (re)
        if ("api" == re.getAttribute("source")) {
          const e = `https://wayback-api.archive.org/services/context/notices?url=${encodeURIComponent(
            a
          )}&timestamp=${F}`;
          $(e, { credentials: "omit" })
            .then((e) => e.json())
                  ...
                  for (let e of s)
                    "string" == typeof e.notice &&
                      o(() => {
                        ...
                        (s.innerHTML = e.notice), t.appendChild(s);
                      });
                  re.appendChild(e), o(() => re.appendChild(t)), X(!0);
                } catch (e) {
                  console.error(
      ...
      new U(W("wm-save-snapshot-open"), a, F), J();
    },
    ex: Y,
    ajax: l,
    sp: function () {
    ...
    pc: function (e) {
      (Math.random() < e ||
        (document.cookie.search("logged-in-user") >= 0 &&
          document.cookie.search("logged-in-sig") >= 0)) &&
