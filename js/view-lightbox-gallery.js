...
}
{
  ...
  function Portfolio_Gallery_Lightbox_Glalery(id) {
    ...
    _this.defaultBlockWidth =
      portfolio_param_obj.portfolio_gallery_ht_view6_width;
      ...
      var options = {
        ...
        masonry: {
          columnWidth:
            _this.defaultBlockWidth +
            10 +
            portfolio_param_obj.portfolio_gallery_ht_view6_border_width * 2,
        },
        masonryHorizontal: {
          rowHeight: 300 + 10,
        },
  ...
  jQuery(document).ready(function () {
    jQuery(".huge_it_portfolio_container.view-lightbox-gallery").each(function (
      i
    ) {
...
/*
     FILE ARCHIVED ON 22:00:51 Dec 31, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 08:45:26 Feb 27, 2025.
...
playback timings (ms):
  ...
  esindex: 0.008
  cdx.remote: 5.474
  LoadShardBlock: 148.666 (3)
  PetaboxLoader3.datanode: 75.013 (4)
  PetaboxLoader3.resolve: 87.627 (2)
  load_resource: 65.624
*/
